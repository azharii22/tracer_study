...
<div class="main-panel">
  <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12">
            <h5 class="text-center">Tabel Form Kuisioner Pengguna Alumni</h5>
            <a href="{{ route ('buat-kuisioner-pengguna-alumni')}}" class="btn btn-primary" title="Tambah" data-toggle="tooltip">
                       ...
                       <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <a href="/kuisioner-pengguna-alumni/delete{{ $data->id }}" class="btn btn-danger btn-sm mr-2" title="Hapus" data-toggle="tooltip" onclick="return confirm('Anda yakin mau menghapus pertanyaan nomor {{$i}} ?')"> Delete<i class="typcn typcn-delete-outline btn-icon-append"></i></a>
                          </div>
                        </td>
                      </tr>
                      @endforeach
